...
#define K_SYSCALL_DRIVER_MUX_CONTROL(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, mux_control, MUX_CONTROL)
...
#define K_SYSCALL_DRIVER_UHC(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, uhc, UHC)
